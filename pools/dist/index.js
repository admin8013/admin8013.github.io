...
var POOLS_CONFIG_BY_CHAIN = {
  ...
  [chains.ChainId.BSC]: pools2,
  [chains.ChainId.BSC_TESTNET]: pools3,
  [chains.ChainId.ARBITRUM_ONE]: pools4,
  [chains.ChainId.ARBITRUM_GOERLI]: pools5,
  [chains.ChainId.ZKSYNC]: pools6,
  [chains.ChainId.ZKSYNC_TESTNET]: pools7,
  [chains.ChainId.BASE]: pools8,
  [chains.ChainId.BASE_TESTNET]: pools9,
  [chains.ChainId.LINEA]: pools10,
  [chains.ChainId.LINEA_TESTNET]: pools11,
  [chains.ChainId.POLYGON_ZKEVM]: pools12,
  [chains.ChainId.POLYGON_ZKEVM_TESTNET]: pools13
};
var LIVE_POOLS_CONFIG_BY_CHAIN = {
  [chains.ChainId.ETHEREUM]: livePools,
  [chains.ChainId.BSC]: livePools2,
  [chains.ChainId.BSC_TESTNET]: livePools3,
  [chains.ChainId.ARBITRUM_ONE]: livePools4,
  [chains.ChainId.ARBITRUM_GOERLI]: livePools5,
  [chains.ChainId.ZKSYNC]: livePools6,
  [chains.ChainId.ZKSYNC_TESTNET]: livePools7,
  [chains.ChainId.BASE]: livePools8,
  [chains.ChainId.BASE_TESTNET]: livePools9,
  [chains.ChainId.LINEA]: livePools10,
  [chains.ChainId.LINEA_TESTNET]: livePools11,
  [chains.ChainId.POLYGON_ZKEVM]: livePools12,
  [chains.ChainId.POLYGON_ZKEVM_TESTNET]: livePools13
};
